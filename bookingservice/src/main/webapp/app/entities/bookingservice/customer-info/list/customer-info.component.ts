...
import { EntityArrayResponseType, CustomerInfoService } from '../service/customer-info.service';
...
export class CustomerInfoComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICustomerInfo): string => this.customerInfoService.getCustomerInfoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.customerInfos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICustomerInfo[] | null): ICustomerInfo[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.customerInfoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
