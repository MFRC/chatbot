...
describe('Customer Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'repairservice/customer', component: CustomerComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.customers?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
