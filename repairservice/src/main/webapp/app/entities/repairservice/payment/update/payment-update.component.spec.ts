...
describe('Payment Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Customer query and add missing value', () => {
      const payment: IPayment = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const customer: ICustomer = { id: '031117df-2040-44f9-aeb8-42fcaa65420e' };
      payment.customer = customer;

      const customerCollection: ICustomer[] = [{ id: '336182ee-515e-424b-9f62-778b1feedc88' }];
    ...
    it('Should update editForm', () => {
      const payment: IPayment = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const customer: ICustomer = { id: 'c67be0ac-741f-40f3-840d-5969c374b995' };
      payment.customer = customer;
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      ...
      const payment = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
