  ...
  return {
    plugins: [
      new ModuleFederationPlugin({
        remotes: {
          bookingservice: 'bookingservice@/services/bookingservice/remoteEntry.js',
          chatbotservice: 'chatbotservice@/services/chatbotservice/remoteEntry.js',
          repairservice: 'repairservice@/services/repairservice/remoteEntry.js',
          customerservice: 'customerservice@/services/customerservice/remoteEntry.js',
        },
        shared: {
