...
describe('ChatSession routing resolve service', () => {
  ...
  let routingResolveService: ChatSessionRoutingResolveService;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(ChatSessionRoutingResolveService);
  ...
  describe('resolve', () => {
    it('should return IChatSession returned by find', () => {
      ...
      expect(resultChatSession).toEqual({ id: '9fec3727-3421-4967-b213-ba36557ca194' });
    });
