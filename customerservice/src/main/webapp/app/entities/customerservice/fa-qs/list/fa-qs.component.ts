...
import { EntityArrayResponseType, FAQsService } from '../service/fa-qs.service';
...
export class FAQsComponent implements OnInit {
  ...
  trackId = (_index: number, item: IFAQs): string => this.fAQsService.getFAQsIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.fAQs = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IFAQs[] | null): IFAQs[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.fAQsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
